...
accuracy_multinom(predicted = players_mlogit2_fitted, 
                  real = players_train$player_positions)
```
Multinomial logit model with all variables has the highest accuracy
...
```
```{r}
players_train_knn1a$finalModel$k
players_train_knn1b$finalModel$k
players_train_knn2a$finalModel$k
players_train_knn2b$finalModel$k
```
...
players.svm_poly <- train(player_positions ~ ., 
                        data = players_train, 
                        method = "svmPoly",
...
plot(players.svm_poly$finalModel)

players_test$fore_svm_poly <- predict(players.svm_poly, 
                                    newdata = players_test)

confusionMatrix(players_test$fore_svm_poly,
                players_test$player_positions)

players.svm_Radial <- train(player_positions ~ .,
                           data = players_train, 
                           method = "svmRadial",
...
players.svm_Radial$finalModel

plot(players.svm_Radial$finalModel)

players_test$fore_svm_Radial <- predict(players.svm_Radial, 
                                       newdata = players_test)

confusionMatrix(players_test$fore_svm_Radial,
                players_test$player_positions)
